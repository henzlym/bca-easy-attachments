...
const accessKey =
	"bf623eb6ee39cc322bb85c8e4575cda12670ee12cbfd85376bac4a022400edde";
...
export default class Sidebar extends Component {
	...
	easyAttachmentsFetch(path, fetchMethod, params = null) {
		let queryData =
			params !== null
				? Object.assign({ client_id: accessKey }, params)
				: { client_id: accessKey };
	...
	getCollection(collectionID) {
		...
		let response = this.easyAttachmentsFetch(
	...
	loadMore() {
		const { searchTerm, selectedCollection, currentPage, photos, lastPage } =
			this.state;
					...
					<div className="easy-attachments-sidebar">
						...
						{this.state.photos.length > 0 && this.state.lastPage > 1 && (
							<div className="easy-attachments-sidebar_loadmore">
								<Button isDefault onClick={this.loadMore}>
									Load More
								</Button>
							</div>
						)}
